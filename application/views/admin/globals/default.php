<?php 
 ...
 <div class="pmf-container" style="margin-left:auto; margin-right:auto; margin-top:30px;  min-height:800px; ">
 	    ...
 	    <div class="row" style="margin-left:30px; margin-right:30px;">
 	       <div class="col-sm-12">
 	         ...
 	         <ul class="breadcrumb">
 	           ...
 	           <li class='active'><a href="#"><i class="fa fa-list-ul"></i> <?php echo('Globals');?></a></li>
	 ...
	 <div class="row" style="margin-left:30px; margin-right:30px;">
	   <div class="col-sm-12">
	       <header class="panel-heading"><div class="inline font-bold">Global Variables</div>
          <div class="pull-right btn btn-sm  btn-info btn-rounded" data-toggle="popover" data-html="true" data-placement="bottom" data-content="These can be accessed from any template i.e it is a global variable" title="" data-original-title='<button type="button" class="close pull-right" data-dismiss="popover">&times;</button>Info'> <i class="fa fa-question"></i> <strong></strong> 
                          </div>
                    	...
                    	<?php foreach ($query->result() as $row): ?>
                         ...
                         ?>
                    		<tr>
		                        ...
		                        <td>
		                        	<a href="<?php echo site_url("admin/globals/render_section/$sectionid/$id"); ?> "><?php echo $row->name; ?></a>
		                        </td>
