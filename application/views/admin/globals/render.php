	   ...
	   <div class="row" style="margin-left:30px; margin-right:30px;">
	      <div class="col-sm-12">
	        ...
	        <ul class="breadcrumb">
	          ...
	          <li class='active'><a href="<?php echo site_url('admin/globals'); ?>"><i class="fa fa-list-ul"></i> <?php echo('Globals');?></a></li>
		...
		<div class="col-sm-8">
		    ...
		    <section class="panel">
		        ...
		        <div class="panel-body">
                    ...
                    <?php $atts= array( 'data-validate'=>'parsley'); echo form_open_multipart("admin/globals/save_content/$sectionid/$entryid",$atts); ?>
		        	<!-- rich text editor -->
